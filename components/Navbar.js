						...
						<div className="flex items-center sm:mx-10 md:mx-10 justify-between w-full">
							<div className="flex justify-center items-center flex-shrink-0 ">
								<h1 className=" font-bold text-xl cursor-pointer">
									<Link href="/">
										<a className="text-purple-500 pl-8 sm:pl-0">
											Me<span className="text-cyan-500">DΛS</span>
										</a>
									</Link>
								</h1>
							</div>
							...
							<div className="flex justify-center items-center flex-shrink-0 md:block">
								<div className="flex space-x-4">
									<div>
										<a
											href="https://github.com/MeDVSSS13"
											target="_blank"
									...
									<div>
										<a
											href="https://www.linkedin.com/in/dastan-keneshbekov-bbabb129a/"
											target="_blank"
											rel="noopener noreferrer"
										>
